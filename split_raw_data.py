...
if __name__ == "__main__":
    ...
    # meta_raw_data = RawData(os.path.join(root_dir,"RoboSkills-meta"))
    ...
    """adjust splits"""
    # meta_data = Dataset(os.path.join(root_dir, "RoboSkills-meta"))
    ...
    # meta_data = Dataset(os.path.join(root_dir, "RoboSkills-meta", "v2"))
